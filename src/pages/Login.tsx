          ...
          <Card className="shadow-elevated border-0">
            ...
            <CardContent>
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Button type="button" variant="ghost" size="sm" className="absolute right-0 top-0 h-11 px-3 py-2 hover:bg-transparent" onClick={() => setShowPassword(!showPassword)}>
              ...
              <div className="mt-6 text-center">
                <Button type="button" variant="link" onClick={() => setIsSignUp(!isSignUp)} className="text-primary hover:underline">
